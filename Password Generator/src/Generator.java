...
public class Generator {
    ...
    public void mainLoop() {
    	System.out.println();
        System.out.println("Welcome to (: SysPass :) Password Services :)");
        System.out.println();
        printMenu();
    ...
    private void printMenu() {
        ...
        System.out.println("Enter 3 - Get Information about Password Strength");
        System.out.println("Enter 4 - Exit");
        System.out.print("Pick Choice:");
    }

    private void printQuitMessage() {
    	System.out.println("Thank You for using SysPass Password Service");
